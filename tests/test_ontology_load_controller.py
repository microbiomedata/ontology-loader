...
def test_obsolete_terms_end_to_end(mock_mongodb_loader, mock_ontology_processor):
    ...
    mock_relations = [
        OntologyRelation(subject="ENVO:0000001", predicate="related_to", object="ENVO:0000003", type="nmdc:OntologyRelation"),
        # Deliberately including a relation to/from an obsolete term - should be filtered out
        OntologyRelation(subject="ENVO:0000002", predicate="related_to", object="ENVO:0000001", type="nmdc:OntologyRelation"),
        OntologyRelation(subject="ENVO:0000003", predicate="related_to", object="ENVO:0000002", type="nmdc:OntologyRelation"),
    ]
