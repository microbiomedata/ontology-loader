...
def test_obsolete_handling_in_ontology_loader():
    ...
    class_collection.upsert([test_obsolete_term],
                            filter_fields=["id"],
                            update_fields=["id", "name", "type", "is_obsolete"])
    ...
    relation_collection.upsert([test_relation],
...
def test_obsolete_handling_with_mocks():
    ...
    from ontology_loader.mongodb_loader import _handle_obsolete_terms, _upsert_relation
