...
class _FakeOntologyProcessor:
    ...
    def get_relations_closure(self, closure="combined", ontology_terms=None, **kwargs):
        # Accept and ignore any extra keyword arguments so the fake stays
        # forward-compatible with future call-site additions.
        relations = [
            {
                "subject": "TEST:002",
